...
private:
   ...
   void AddFloatConditionInstruction( const std::vector<std::string>& tokenLine, ConditionOp op, int falseIndex );
   void AddIntConditionInstruction( const std::vector<std::string>& tokenLine, ConditionOp op, int falseIndex );
   ...
   mbc_instruction CreateFloatMathInstruction( const std::vector<std::string>& tokenLine, MathOp op ) const;
   mbc_instruction CreateIntMathInstruction( const std::vector<std::string>& tokenLine, MathOp op ) const;
